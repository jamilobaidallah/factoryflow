...
exports.resolveAccountMapping = resolveAccountMapping;
// ── Account constants ────────────────────────────────────────────────────────
...
const CATEGORY_TO_EXPENSE_FALLBACK = {
 ...
 */
function resolveAccountMapping(input) {
    ...
    if (type === 'مصروف') {
        ...
        const expenseAcc = (subCategory ? SUBCATEGORY_TO_EXPENSE[subCategory] : undefined) ??
